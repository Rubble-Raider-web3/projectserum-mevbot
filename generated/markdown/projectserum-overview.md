...
##### What are the main weaknesses of DeFi  

- [x]  Segmented Liquidity
- [x]  Settlement Risk
...
##### What is the main cause of Segmented Liquidity on Ethereum  

- [ ]  Most of the liquidity is locked
- [ ]  Low transaction speed
- [x]  Protocols have their own liquidity, and they don't share the liquidity.
- [ ]  All the above
...
##### Why did Serum Team decided to build Serum DEX on Solana instead of Ethereum  

- [x]  Because Solana supports 50k transactions per second
- [ ]  Becuase Solana is Ethereum Virtual Machine Compatible
- [x]  Block times of approximately 400ms
- [x]  Network fees of ~$0.0001 per transaction





##### What are the consensus mechanisms used by Solana  
...
##### Which of these is not a core building block of Project Serum?  
...
##### How does Serum achieve true composability?  

- [ ]  By sharing the user's KYC information with all applications.
- [x]  By allowing different applications and users to share data and liquidity in one place
- [ ]  By using Rust language for its code.
- [ ]  All the above
...
##### What is main offering of Serum Core?  

- [ ]  Serum Core provides off-chain order book with syncs data with Solana Blockchain at regular intervals
- [ ]  Serum Core offers set of reusable Smart Contracts which makes it easy to write code on Solana
- [ ]  Serum Core offers a lending and borrowing engine
- [x]  Serum Core provides an on-chain asset-agnostic Cental Limit Order Book





##### What type of applications can be build on top of Serum  

- [ ]  Decentralized Exchange Clients
- [ ]  Option/Futures related Financial Applications
